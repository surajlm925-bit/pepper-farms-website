const cards = [
  {
    ...
    image: '/images/fresh-produce/WhatsApp Image 2026-01-19 at 16.34.03.jpeg',
  },
  {
    icon: '🔥',
    ...
    image: '/images/fresh-produce/WhatsApp Image 2026-01-19 at 16.34.02 (1).jpeg',
  },
  {
    icon: '🚛',
    ...
    image: '/images/fresh-produce/WhatsApp Image 2026-01-19 at 16.34.01 (2).jpeg',
  },
];
  ...
  return (
    <section className="sourcing" id="sourcing">
      <div style={{ textAlign: 'center' }}>
        ...
        <h2 className="section-heading reveal reveal-delay-1">"If it grows on our farm,<br/>we use it."</h2>
      </div>
      ...
      <div style={{ textAlign: 'center', marginTop: '56px' }} className="reveal">
        ...
        <div className="menu-cta-duo">
          <a
            href="https://wa.me/919535072044?text=Hi%20Pepperfarm!%20I%20want%20to%20order%20my%20first%20meal."
            target="_blank"
